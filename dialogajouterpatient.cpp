 ...
 */
void DialogAjouterPatient::init_ressource_list()
{
 ...
 */
void DialogAjouterPatient::update_ressource_list()
{
    model->clear();
    init_ressource_list();
}
 ...
 */
void DialogAjouterPatient::init_ressource_reserved_list()
{
 ...
 */
void DialogAjouterPatient::update_ressource_reserved_list()
{
    model_res->clear();
 ...
 */
void DialogAjouterPatient::on_tableView_doubleClicked(const QModelIndex &index)
{
    if(index.column() != 0) {
        //Qmessage
        QMessageBox msgBox;
 ...
 */
bool DialogAjouterPatient::on_nomEdit_editingFinished()
{
    bool finish = true;
 ...
 */
bool DialogAjouterPatient::on_prenomEdit_editingFinished()
{
    bool finish = true;
 ...
 */
bool DialogAjouterPatient::on_spinBox_editingFinished()
{
    bool finish = true;
 ...
 */
bool DialogAjouterPatient::on_dureeEdit_editingFinished()
{
    bool finish = true;
 ...
 */
bool DialogAjouterPatient::on_cpEdit_editingFinished()
{
    bool finish = true;
 ...
 */
bool DialogAjouterPatient::on_villeEdit_editingFinished()
{
    bool finish = true;
 ...
 */
bool DialogAjouterPatient::on_adresseEdit_textChanged()
{
    bool finish = true;
 ...
 */
void DialogAjouterPatient::on_pushButton_del_clicked()
{
    //delete
 ...
 */
bool DialogAjouterPatient::all_editors_full()
{
 ...
 */
void DialogAjouterPatient::on_buttonBox_accepted()
{
    if(all_editors_full()) {
        // Q.4
 ...
 */
void DialogAjouterPatient::on_buttonBox_rejected()
{
    this->close();
}

//get comm and drive
QString DialogAjouterPatient::getCommAndDri()
{
    this->comm_and_dri;
}
